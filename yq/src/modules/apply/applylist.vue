<template>
	<div class="table">
			...
			<div class="handle-box table-cuoff-line">
				<el-row type="flex" justify="space-between" align="center">
					<el-col>
                        ...
                        <el-select v-model="state" placeholder="采集网点" :change="select_stauts"  @change="select_stauts"  style="width:100px;">
                            <el-option key="" label="全部" value=""></el-option>
                        ...
                        <el-select v-model="payType" placeholder="订单类型" :change="select_stauts"  @change="select_stauts"  style="width:100px;">
                            <el-option key="" label="全部" value=""></el-option>
		...
		<!-- 结束增加弹出框 -->
		<!-- 开始修改弹出框 -->
		<el-dialog title="修改预约检测订单" :visible.sync="editVisible" width="400px">
			<el-form ref="editForm" :model="editForm" :rules="rules" label-width="117px">
				<el-form-item label="申请编号" prop="applyNumber">
					<el-input v-model="editForm.applyNumber" class="handle-input"></el-input>
				</el-form-item>
				<el-form-item label="预约采集网点" prop="checkOrgNumber">
					<el-input v-model="editForm.checkOrgNumber" class="handle-input"></el-input>
				</el-form-item>
				<el-form-item label="姓名" prop="applyName">
					<el-input v-model="editForm.applyName" class="handle-input"></el-input>
				</el-form-item>
				<el-form-item label="生日" prop="birthDay">
					<el-input v-model="editForm.birthDay" class="handle-input"></el-input>
				</el-form-item>
				<el-form-item label="性别" prop="sex">
					<el-input v-model="editForm.sex" class="handle-input"></el-input>
				</el-form-item>
				<el-form-item label="地址" prop="address">
					<el-input v-model="editForm.address" class="handle-input"></el-input>
				</el-form-item>
				<el-form-item label="创建时间" prop="createTime">
					<el-input v-model="editForm.createTime" class="handle-input"></el-input>
				</el-form-item>
				<el-form-item label="预约日期" prop="applyTime">
					<el-input v-model="editForm.applyTime" class="handle-input"></el-input>
				</el-form-item>
				<el-form-item label="联系人" prop="contact">
					<el-input v-model="editForm.contact" class="handle-input"></el-input>
				</el-form-item>
				<el-form-item label="电话" prop="tel">
					<el-input v-model="editForm.tel" class="handle-input"></el-input>
				</el-form-item>
				<el-form-item label="身份证号" prop="idcard">
					<el-input v-model="editForm.idcard" class="handle-input"></el-input>
				</el-form-item>
				<el-form-item label="代理申请人 " prop="helpPersonName">
					<el-input v-model="editForm.helpPersonName" class="handle-input"></el-input>
				</el-form-item>
				<el-form-item label="代理申请人电话" prop="helpPersonTel">
					<el-input v-model="editForm.helpPersonTel" class="handle-input"></el-input>
				</el-form-item>
				<el-form-item label="代理申请人身份证号" prop="helpPersonIdCard">
					<el-input v-model="editForm.helpPersonIdCard" class="handle-input"></el-input>
				</el-form-item>
			</el-form>
			<span slot="footer" class="dialog-footer">
...
export default {
	 ...
	 methods: {
		...
		getcheckOrgData() {
			axios.post({url: api.commn.action,
				 data: {model:'tb_check_org',action:'select'}
			 }).then(res => {
				 if (res.code == 0) {
