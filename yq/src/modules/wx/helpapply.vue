...
export default {
    data() {
        return {
            ...
            relations: [
                {
                    flex: 1,
                    values: [{text:'本人'},{text:'亲人'}, {text:'朋友'}, {text:'同事'}, {text:'同学'}, {text:'其他'}],
                    className: 'slot1',
                    textAlign: 'center'
                }
            ],
    ...
    methods: {
        ...
        init(){
             ...
             this.addForm.applyTime = getCurrentDate();
        ...
        handleEnterRelation() {
            ...
            this.addForm.checkOrgNumber = this.currentpopupRelationValue.value;
             this.addForm.checkOrgName = this.currentpopupRelationValue.text;
        ...
        validate() {
          ...
          if(!this.addForm.address){
            ...
            // if(!this.checkIdCard(this.addForm.helpPersonIdCard))
            // {               
            //     Toast('请填写正确的请输入代理人身份证号');
            //     return false;
            // }
            return true;
