            ...
            <el-table :data="data" border style="width: 100%" ref="multipleTable">
                ...
                <el-table-column label="操作" width="200" fixed="right">
                    <template slot-scope="scope">
                        <el-button type="text" size="small" @click="handleUpdate(scope.$index, scope.row)">修改</el-button>
...
export default {
    ...
    methods: {
        ...
        doSaveAdd(formName) {
            ...
            this.ruleForm.username = this.ruleForm.tel;
            this.ruleForm.password = this.ruleForm.tel;
            this.state = 1;
            this.ruleForm.legalperson = this.ruleForm.contacts;
