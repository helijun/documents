...
if (needCLodop()) {
    ...
    //oscript.src ="//s.1-1dr.com/static/print/lodop/CLodopfuncs-priority1.js";
	head.insertBefore( oscript,head.firstChild );

	//引用双端口(8000和18000）避免其中某个被占用：
	oscript = document.createElement("script");
    oscript.src ="//localhost:18000/CLodopfuncs.js?priority=0";
    //oscript.src ="//s.1-1dr.com/static/print/lodop//CLodopfuncs-priority0.js";
	head.insertBefore( oscript,head.firstChild );
};

//====获取LODOP对象的主过程：====
function getLodop(oOBJECT,oEMBED){
    var lodop32Exe = '//s.1-1dr.com/static/print/lodop/lodop/install_lodop32.exe',
        lodop64Exe = '//s.1-1dr.com/static/print/lodop/lodop/install_lodop64.exe',
        clodopExe = '//s.1-1dr.com/static/print/lodop/CLodop_Setup_for_Win32NT.exe';
