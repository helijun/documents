...
function fadeOut(id) {
	id.removeClass('fadeInDown').addClass('fadeOutDown');
	setTimeout(function() {
		id.hide().removeClass('fadeOutDown');
	},1000);
}
function fadeIn(id) {
	id.show().addClass('fadeInDown animated');
}
function close(id) {
...
function media(b) {
    ...
    function audioPlay() {
        audio.play();
        $music.css("background-position","-51px 0");
        $music.addClass("mAnim");
    }

    function audioPause() {
        audio.pause();
        $music.css("background-position","0 0");
