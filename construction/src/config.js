...
var ENV = {
    ...
    API: '/worksite/', //配合nginx跨域，所有ajax api前缀
    FILE_URL: '/worksite/',//图片上传地址
    PAGE: '/', //页面、js资源、图片地址
    H5: 'http://' + window.location.host + '/page/apply/index.html', //h5页面访问地址前缀
    BASE: 'http://' + window.location.host,//域名url，如本地则是为空
    PROJECT_TIME: 5000,//项目动态刷新频率
    AMAP_KEY: 'vjUUMSF3yrxOQHxYCfx20Xu9WMzNLtwb', //高德地图key
}
