<div class="module-project-add">
    <div class="layui-form">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block" lay-filter="addProOrganizationListFilter">
                <select name="addProOrganizationList" lay-filter="addProOrganizationList"  lay-verify="addProOrganizationList|required" lay-search="">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" id="projectAdress" name="projectAdress" class="layui-input" lay-verify="projectAdress|required" placeholder="请输入项目地址详细地址">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" id="projectDate" name="projectDate" class="layui-input" lay-verify="projectDate|required" placeholder="请选择项目工期" readonly>
            </div>
        </div>
