<div class="module-user-org-edit">
    <div class="layui-form">
        <input type="hidden" name="organizationid" value="{{ d.organizationid}}" class="layui-input">
        <div class="layui-form-item">
            <label class="layui-form-label">会议单位</label>
            <div class="layui-form-mid layui-word-aux">{{ d.name}}</div>
            <input type="hidden" name="name" value="{{ d.name}}" class="layui-input">
        </div>

        <div class="layui-form-item">
            <label class="layui-form-label">会议账号</label>
