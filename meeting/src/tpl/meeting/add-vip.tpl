        ...
        <div class="element-form-content layui-form">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block hs-flex">
                    <div class="vip-face-select" id="vipFaceImg"></div>
            ...
            <div class="layui-form-item">
                <label class="layui-form-label">VIP欢迎语</label>
                <div class="layui-input-inline">
                    <input type="text" name="viptitle" lay-verify="viptitle" autocomplete="off" placeholder="例如“诚邀XXXX先生/女士参加.....”" class="layui-input" maxlength="25">
                    <div class="element-input-tips">25字以内</div>
                </div>
            </div>
            <div class="layui-form-item hs-align-center">
                <button class="layui-btn element-next" lay-submit="element-save" lay-filter="element-save">保存</button>
            </div>
        </div>
    </div>
</div>