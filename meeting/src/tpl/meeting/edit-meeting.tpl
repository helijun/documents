        ...
        <div class="element-content">
            ...
            <div class="meeting-info hs-flex">
                <div class="content-left layui-form">
                    <input type="hidden" value="{{d.meetingid}}" name="meetingid">
                    <div class="layui-form-item">
                        <label class="layui-form-label"><em>*</em>会议标题</label>
                        <div class="layui-input-inline">
                            <input type="text" name="title" id="meetingTitle" lay-verify="required|meetingTitle" autocomplete="off" placeholder="请输入会议标题" class="layui-input" maxlength="20" value="{{d.title}}">
                    ...
                    <div class="layui-form-item">
                        <label class="layui-form-label">
                            <em>*</em>会议内容</label>
                        <div class="layui-input-inline">
                            <textarea placeholder="请输入会议内容" name="content" id="meetingContent" lay-verify="required|meetingContent" class="layui-textarea" maxlength="150">{{d.content}}</textarea>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline element-datetime-input">
                            <input type="text" name="meetingdatetime" id="meetingdatetime" lay-verify="required|meetingdatetime" autocomplete="off" placeholder="请选择举办时间" class="layui-input" value="{{d.holdtimestart.substr(0,16)}} ~ {{d.holdtimeend.substr(0,16)}}" readonly>
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">
                            <em>*</em>举办地点</label>
                        <div class="layui-input-inline">
                            <input type="text" name="address" id="meetingLocation" lay-verify="required|meetingLocation" autocomplete="off" placeholder="请输入举办地点" class="layui-input" value="{{d.address}}" maxlength="50">
                ...
                <div class="content-right">
                    ...
                    <div class="element-mobile">
                        <div class="element-mobile-content">
                            <!-- 所有要联动的以change-开头 -->
                            <div class="change-meeting-info-title"><!-- 禾思科技2017年会 -->{{d.title}}</div>             
                            <div class="change-meeting-info-content"> <!-- 禾思科技 2017 年会介XXX XXXXXXXXXXXXXXXXXXXXXX XXXXXXXXXXXXXXXXXXXXXX XXXXXXX -->{{d.content}}</div>
                            <div class="change-meeting-info-datetime">
                                举办时间：<span><!-- 17.12.08 08:30- 1712.08 11:30 -->{{d.holdtimestart.substr(0,16)}} ~ {{d.holdtimeend.substr(0,16)}}</span>
                            </div>
                            <div class="change-meeting-info-location">
                                 举办地点：<span><!-- 深圳市南山区生态科技 厦1单元3603 -->{{d.address}}</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="content-left layui-form">
                    <div class="layui-form-item">
                        <label class="layui-form-label">
                            <em>*</em>报名有效期</label>
                        <div class="layui-input-inline">
                            <input type="text" name="meetingapplytime" id="meetingApplyTime" lay-verify="meetingApplyTime" autocomplete="off" placeholder="请选择报名有效期" class="layui-input" value="{{d.applystarttime.substr(0,16)}} ~ {{d.applyendtime.substr(0,16)}}" readonly>
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">
                        ...
                        <div class="layui-input-block">
                            ...
                            <div class="form-header-set">
                                <div class="form-header-select" id="uploadHeaderImg">
                                    {{# if(d.backgroundimage && d.backgroundimage.indexOf('default') < 0){ }}
                                        <img class="hs-all-img" src="{{ d.backgroundimage}}" />
                                    {{# } }}
                                </div>
                                <div class="form-header-desc">
                                    <p>背景图片尽量保持简洁 <em class="form-header-example">示例</em></p>
                                    <p>本地上传图片支持png / jpg格式，10M以内，建议640px*250px</p>
                                </div>
                            </div>
                            <p class="element-sub-title">2.邀请语设置</p>
                            <div class="layui-input-inline element-recommend">
                                <input type="text" name="invitetitle" lay-verify="required|recommend" id="recommend" autocomplete="off" placeholder="诚邀您" class="layui-input" maxlength="20" value="{{d.invitetitle}}">
                            </div>
                        </div>
                    </div>
                    <div class="layui-form-item">
                    ...
                    <div class="element-mobile">
                        <div class="element-mobile-content">
                            ...
                            {{# if(d.backgroundimage){ }}
                                <div class="change-apply-form-headimg" style="background:url({{d.backgroundimage}});background-size:cover">
                            {{# }else{ }}
                                <div class="change-apply-form-headimg">
                            {{# } }}
                                <p class="element-title change-meeting-info-title"><!-- 禾思科技2017年会 -->{{d.title}}</p>
                            </div>
                            <div class="change-apply-form-recommend"> 
                                <p class="element-recommend-start">诚邀您</p>
                                <p class="element-recommend-text change-meeting-form-recommend"><!-- 参加禾思科技2017年会参加禾思科技2017年会参加禾思科技2017年会 -->{{d.invitetitle}}</p>
                            </div>
                ...
                <div class="content-left layui-form" lay-filter="enter-info-form">
                    <div class="layui-form-item">
                        <label class="layui-form-label">
                            <em>*</em>签到有效期</label>
                        <div class="layui-input-inline">
                            <input type="text" name="meetingsigntime" id="meetingsigntime" lay-verify="required|meetingsigntime" autocomplete="off" placeholder="请选择签到有效期" class="layui-input" value="{{d.signinstarttime.substr(0,16)}} ~ {{d.signinendtime.substr(0,16)}}" readonly>
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">
                            <em>*</em>签到地址</label>
                        <div class="layui-input-inline">
                            <input type="text" name="signinaddress" id="meetingSignLocation" lay-verify="required|meetingSignLocation" autocomplete="off" placeholder="请输入签到地址" class="layui-input" maxlength="20" value="{{d.signinaddress}}">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">
                            <em>*</em>签到欢迎语</label>
                        <div class="layui-input-inline">
                            <input type="text" name="signinwelcome" id="meetingSignWelcome" lay-verify="required|meetingSignWelcome" autocomplete="off" placeholder="请输入签到欢迎语" class="layui-input" maxlength="20" value="{{d.signinwelcome}}">
                            <div class="element-input-tips">20字以内</div>
                        </div>
                    </div>
                    <div class="layui-form-item">
                    ...
                    <div class="layui-form-item {{ d.hasMachineType == 1?'layui-hide':'' }}">
                        ...
                        <div class="layui-input-block">
                            ...
                            <div class="hs-checkbox" name="machine-screen-diy" data-show="area-machine-screen">
                                {{# if(d.uprighscreensaver && d.uprighscreensaver.indexOf('default') > 0){ }}
                                    <i class="icon-checkbox-select"></i> 自定义屏保
                                {{# }else{ }}
                                    <i class="icon-checkbox-selected"></i> 自定义屏保
                                {{# } }}
                            </div>
                            <div class="hs-checkbox" name="machine-screen-default" data-show="area-machine-screen">
                                {{# if(d.uprighscreensaver && d.uprighscreensaver.indexOf('default') > 0){ }}
                                    <i class="icon-checkbox-selected"></i> 默认屏保
                                {{# }else{ }}
                                    <i class="icon-checkbox-select"></i> 默认屏保
                                {{# } }}
                            </div>
                        </div>
                        
                        {{# if(d.uprighscreensaver && d.uprighscreensaver.indexOf('default') < 0){ }}
                            <div class="layui-input-block hs-flex" data-area="area-machine-screen">
                                <div class="machine-screen-select" id="uploadMachineScreenImg">
                                    <img class="hs-all-img" src="{{d.uprighscreensaver}}" />
                        {{# }else{ }}
                        ...
                        {{# } }}
                            ...
                            <div class="element-desc machine-screen-desc">
                                ...
                                <p>本地上传图片支持png / jpg格式，10M以内，建议1920px*1080px</p>
                            </div>
                        </div>
                        <br>
                        ...
                        <div class="layui-input-block">
                            ...
                            <div class="hs-checkbox" name="machine-recognize-diy" data-show="area-machine-recognize">
                                {{# if(d.uprightui && d.uprightui.indexOf('default') > 0){ }}
                                    <i class="icon-checkbox-select"></i> 自定义海报
                                {{# }else{ }}
                                    <i class="icon-checkbox-selected"></i> 自定义海报
                                {{# } }}
                            </div>
                            <div class="hs-checkbox" name="machine-recognize-default" data-show="area-machine-recognize">
                                {{# if(d.uprightui && d.uprightui.indexOf('default') > 0){ }}
                                    <i class="icon-checkbox-selected"></i> 签到嘉宾展示
                                {{# }else{ }}
                                    <i class="icon-checkbox-select"></i> 签到嘉宾展示
                                {{# } }}
                            </div>
                        </div>
                        
                        {{# if(d.uprightui && d.uprightui.indexOf('default') < 0){ }}
                            <div class="layui-input-block hs-flex" data-area="area-machine-recognize">
                                <div class="machine-recognize-select" id="uploadMachineRecognizeImg">
                                    <img class="hs-all-img" src="{{d.uprightui}}" />
                        {{# }else{ }}
                        ...
                        {{# } }}
                            ...
                            <div class="element-desc machine-recognize-desc">
                                ...
                                <p>本地上传图片支持png / jpg格式，10M以内，建议480px*1080px</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item {{ d.hasMachineType == 2?'layui-hide':'' }}">
                        ...
                        <div class="layui-input-block">
                            ...
                            <div class="hs-checkbox" name="pad-screen-diy" data-show="area-pad-screen">
                                {{# if(d.panelscreensaver && d.panelscreensaver.indexOf('default') > 0){ }}
                                    <i class="icon-checkbox-select"></i> 自定义屏保
                                {{# }else{ }}
                                    <i class="icon-checkbox-selected"></i> 自定义屏保
                                {{# } }}
                        ...
                        {{# if(d.panelscreensaver && d.panelscreensaver.indexOf('default') < 0){ }}
                            <div class="layui-input-block hs-flex" data-area="area-pad-screen">
                                <div class="pad-screen-select" id="uploadPadScreenImg">
                                    <img class="hs-all-img" src="{{d.panelscreensaver}}" />
                        {{# }else{ }}
                        ...
                        {{# } }}
                            ...
                            <div class="element-desc pad-screen-desc">
                                ...
                                <p>本地上传图片支持png / jpg格式，10M以内，建议1280px*800px</p>
                            </div>
                        </div>
                    </div>
                    <div class="layui-form-item hs-align-center">
                ...
                <div class="content-right">
                    ...
                    <div class="hs-tabs-content">
                        ...
                        <div class="element-pad {{ d.hasMachineType == 2?'layui-hide':'' }}">
                            ...
                            {{# if(d.panelscreensaver){ }}
                                {{# if(d.panelscreensaver.indexOf('default') < 0){ }}
                                    <div class="element-pad-screen change-pad-screen" style="background:url({{d.panelscreensaver}});background-size:cover">
                                {{# }else{ }}
                            ...
                            {{# }else{ }}
                                <div class="element-pad-screen change-pad-screen">
                            {{# } }}
                                    <p class="change-meeting-info-title">{{d.title}}</p>
                                </div>
                                <div class="element-pad-recognize layui-hide">
                                    <p class="change-meeting-info-title">{{d.title}}</p>
                                    <p class="change-meeting-info-welcome">{{d.signinwelcome}}</p>
                                </div>
                            </div>
                        </div>
                        <!-- 立式机 -->
                        <div class="element-machine  {{ (d.hasMachineType == 1 || d.hasMachineType == 3)?'layui-hide':'' }}">
                            <div class="element-machine-content">
                                ...
                                <div class="sub-tabs-content">
                                    {{# if(d.uprighscreensaver){ }}
                                        {{# if(d.uprighscreensaver.indexOf('default') < 0){ }}
                                            <div class="element-machine-screen change-machine-screen" style="background:url({{d.uprighscreensaver}});background-size:cover">
                                        {{# }else{ }}
                                    ...
                                    <div class="element-machine-recognize layui-hide">
                                        ...
                                        {{# if(d.uprightui){ }}
                                            {{# if(d.uprightui.indexOf('default') < 0){ }}
                                                <div class="change-machine-recognize" style="background:url({{d.uprightui}});background-size:cover"></div>
                                            {{# }else{ }}
            ...
            <div class="meeting-success layui-hide">
                <div class="element-tips">
                    <i class="icon-success"></i> 您的会议已修改成功! 
                </div>
