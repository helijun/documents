			...
			refreshView : function(){
				...
				if(initVal){
					...
					if (option.defaultDate) {
						...
						date = new Date(option.minDate);
					}else if(option.defaultDate && option.minDate){
						date = new Date(option.defaultDate);
					}else{
						date = new Date();
					}
